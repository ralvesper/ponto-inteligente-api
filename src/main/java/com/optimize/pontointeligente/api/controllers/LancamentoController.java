...
import com.optimize.pontointeligente.api.dtos.LancamentoDto;
import com.optimize.pontointeligente.api.entities.Funcionario;
import com.optimize.pontointeligente.api.entities.Lancamento;
import com.optimize.pontointeligente.api.enums.TipoEnum;
...
import com.optimize.pontointeligente.api.services.LancamentoService;
...
public class LancamentoController {
	...
	public ResponseEntity<Response<LancamentoDto>> listarPorId(@PathVariable("id") Long id) {
		...
		if (!lancamento.isPresent()) {
			...
			response.addError("Lançamento não encontrado para o id " + id);
	...
	public ResponseEntity<Response<String>> remover(@PathVariable("id") Long id) {
		...
		if (!lancamento.isPresent()) {
			...
			response.addError("Erro ao remover lançamento. Registro não encontrado para o id " + id);
			return ResponseEntity.badRequest().body(response);
		}
