...
import com.optimize.pontointeligente.api.dtos.FuncionarioDto;
import com.optimize.pontointeligente.api.entities.Funcionario;
import com.optimize.pontointeligente.api.response.Response;
import com.optimize.pontointeligente.api.services.FuncionarioService;
import com.optimize.pontointeligente.api.utils.PasswordUtils;
...
public class FuncionarioController {
	...
	public ResponseEntity<Response<FuncionarioDto>> atualizar(@PathVariable("id") Long id,
		...
		this.validarDadosAlteracao(funcionario, funcionarioDto, result);
		...
		this.atualizarDadosFuncionario(funcionario.get(), funcionarioDto);
	...
	private void validarDadosAlteracao(Optional<Funcionario> funcionario, FuncionarioDto funcionarioDto,
			BindingResult result) {

		if (!funcionario.isPresent()) {
			result.addError(new ObjectError("funcionario", "Funcionário não encontrado."));
		} else {
			if (!funcionario.get().getEmail().equals(funcionarioDto.getEmail())) {
